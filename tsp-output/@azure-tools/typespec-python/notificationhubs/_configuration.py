...
class NotificationHubsClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        super(NotificationHubsClientConfiguration, self).__init__(**kwargs)
        ...
        kwargs.setdefault("sdk_moniker", "notificationhubsclient/{}".format(VERSION))
