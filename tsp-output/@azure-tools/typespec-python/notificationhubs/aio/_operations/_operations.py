...
from ..._operations._operations import (
    build_notification_hubs_cancel_notification_request,
    build_notification_hubs_create_or_update_installation_request,
    build_notification_hubs_delete_installation_request,
    build_notification_hubs_get_feedback_container_url_request,
    build_notification_hubs_get_installation_request,
    build_notification_hubs_update_installation_request,
)
from .._vendor import NotificationHubsClientMixinABC, raise_if_not_implemented
...
class NotificationHubsClientOperationsMixin(NotificationHubsClientMixinABC):
    ...
    async def get_installation(self, installation_id: str, **kwargs: Any) -> _models.Installation:
    ...
    @distributed_trace_async
    async def delete_installation(  # pylint: disable=inconsistent-return-statements
    ...
    @distributed_trace_async
    async def cancel_notification(self, notification_id: str, **kwargs: Any) -> str:
    ...
    @distributed_trace_async
    async def get_feedback_container_url(self, **kwargs: Any) -> str:
